...
export default function (params) {
    return {
        ...
        loadField() {
            //this.microformNumberField = this.$store.svcCybersource.createConfirmAccountNumberField();
            this.$store.svcCybersource.loadConfirmAccountNumberField(this.mxField_id); 
        },
        onChange(ev) {
